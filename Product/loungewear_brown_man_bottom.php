...
<?php
    $product_img_dir = '../productpictures/loungewear/male/brown/loungewear_brown_man_bottom.jpg';
    $product_name = 'loungewear_brown_man_bottom';
    $product_title = 'loungewear_brown_man_bottom';
    $product_description = 'loungewear_brown_man_bottom';
