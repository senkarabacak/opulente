...
<?php
    $product_img_dir = '../productpictures/loungewear/male/black/loungewear_black_man_bottom.jpg';
    $product_name = 'loungewear_black_man_bottom';
    $product_title = 'loungewear_black_man_bottom';
    $product_description = 'loungewear_black_man_bottom';
