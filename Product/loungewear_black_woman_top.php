...
<?php
    $product_img_dir = '../productpictures/loungewear/female/black/loungewear_black_woman_top.jpg';
    $product_name = 'loungewear_black_woman_top';
    $product_title = 'loungewear_black_woman_top';
    $product_description = 'loungewear_black_woman_top';
