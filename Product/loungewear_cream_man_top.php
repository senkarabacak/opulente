...
<?php
    $product_img_dir = '../productpictures/loungewear/male/cream/loungewear_cream_man_top.jpg';
    $product_name = 'loungewear_cream_man_top';
    $product_title = 'loungewear_cream_man_top';
    $product_description = 'loungewear_cream_man_top';
