...
<?php
    $product_img_dir = '../productpictures/loungewear/male/brown/loungewear_brown_man_top.jpg';
    $product_name = 'loungewear_brown_man_top';
    $product_title = 'loungewear_brown_man_top';
    $product_description = 'loungewear_brown_man_top';
