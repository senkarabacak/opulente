...
<?php
    $product_img_dir = '../productpictures/loungewear/male/black/loungewear_black_man_top.jpg';
    $product_name = 'loungewear_black_man_top';
    $product_title = 'loungewear_black_man_top';
    $product_description = 'loungewear_black_man_top';
