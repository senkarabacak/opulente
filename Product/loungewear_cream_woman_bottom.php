...
<?php
    $product_img_dir = '../productpictures/loungewear/female/cream/loungewear_cream_woman_bottom.jpg';
    $product_name = 'loungewear_cream_woman_bottom';
    $product_title = 'loungewear_cream_woman_bottom';
    $product_description = 'loungewear_cream_woman_bottom';
