...
<?php
    $product_img_dir = '../productpictures/loungewear/female/cream/loungewear_cream_woman_top.jpg';
    $product_name = 'loungewear_cream_woman_top';
    $product_title = 'loungewear_cream_woman_top';
    $product_description = 'loungewear_cream_woman_top';
