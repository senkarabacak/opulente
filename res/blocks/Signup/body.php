<div class="body">
    <div class="bInner">
        <form action="config/dbaccess" method='POST' class="biForm">
            <div class="bifHeader title-size w600">Sign Up</div>
            <div class="bifInputs">
                <input type="text" name='login' class="bifiInput" placeholder='Username / Email' minlength="3" required>
                <input type="password" name='pass' class="bifiInput" placeholder='Password' minlength="4" required>
            ...
            <div class="bifRemember">
                ...
                <div class="bifrlcText text-small-size">Remember me</div>
            </div>
            <div class="bifrText text-small-size">Dont  have and account? <span><a href="register" class='w500'>Register</a></span></div>
